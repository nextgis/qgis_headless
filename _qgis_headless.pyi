...
class MapRequest:
    ...
    def export_pdf(
        self, filepath: str, extent: tuple[float, float, float, float], size: tuple[int, int]
    ) -> None: ...
    def legend_symbols(
        self, index: int, size: tuple[int, int] = (0, 0), count: int = 5
    ) -> list[LegendSymbol]: ...
    def render_image(
        self,
    ...
    def render_legend(self, size: tuple[int, int] = (0, 0)) -> Image: ...
...
class Style:
    ...
    def from_file(
        ...
        svg_resolver: typing.Callable[[str], str] = None,
        layer_geometry_type: Layer.GeometryType = Layer.GeometryType.GT_UNKNOWN,
        layer_type: LayerType = LayerType.LT_UNKNOWN,
        format: StyleFormat = ...,
    ) -> Style: ...
    ...
    def used_attributes(self) -> typing.Any: ...
...
def set_svg_paths(paths: list[str]) -> None:
    """
