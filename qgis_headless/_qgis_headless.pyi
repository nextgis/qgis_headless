...
Color = TypeVar("Color", Tuple[int, int, int, int])
Extent = TypeVar("Extent", Tuple[float, float, float, float])
Size = TypeVar("Size", Tuple[int, int])
Paths = TypeVar("Paths", Tuple[str, ...])
SvgResolverCallback = TypeVar("SvgResolverCallback", Callable[[str], str])
...
class MapRequest:
    ...
    def add_layer(layer: Layer, style: Style, label: str = "") -> int: ...
    def render_image(extent: Extent, size: Size) -> Image: ...
    def render_legend(size: Size = [0, 0]) -> Image: ...
    def legend_symbols(index: int, size: Size = (0, 0)) -> Tuple[LegendSymbol, ...]: ...
